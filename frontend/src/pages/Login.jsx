...
//   login with google
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start">
      ...
      <div onSubmit={handleLogin} className="max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex justify-center items-center">
        <form className="w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]">
          ...
          <div className=" w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]">
           ...
           <div className="relative w-[90%]"> 
            ...
            />
            <span className="text-[22px] absolute top-[12px] right-[20px] cursor-pointer " onClick={()=>seteShow(prev=>!prev)}>{show ? <FaEyeSlash />
 :<FaEye />
}</span>
            </div>
...
You haven't any account?
  <span onClick={()=>navigate("/signup")} className="text-purple-500 hover:text-purple-700 cursor-pointer">
    create new account
  </span>
</p>
        </div>
